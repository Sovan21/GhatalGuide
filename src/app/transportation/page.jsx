    ...
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors duration-300 relative">
      ...
      <main className="flex-grow py-12 lg:py-20 relative z-10">
        <div className="container-perfect max-w-5xl">
          ...
          {/* Tabs */}
          <div className="flex bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl rounded-2xl shadow-sm border border-slate-200/60 dark:border-slate-800/60 p-1.5 mb-10 select-none max-w-2xl mx-auto">
            <button
          ...
          <div className="relative">
            {loading ? (
              <div className="flex flex-col items-center justify-center py-20 bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm rounded-3xl border border-slate-200/50 dark:border-slate-800/50 min-h-[300px]">
                <Loader2 className="w-10 h-10 text-indigo-500 animate-spin mb-4" />
                <p className="text-slate-500 dark:text-slate-400 font-medium animate-pulse">Loading schedules...</p>
              </div>
            ) : (
              <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-2xl rounded-3xl shadow-xl shadow-slate-200/20 dark:shadow-none border border-slate-200/80 dark:border-slate-800/80 p-6 md:p-10 overflow-hidden">
                  ...
                  {activeTab === "trains" && (
                    <div className="space-y-8 animate-fade-in">
                      ...
                      {transportData.trains.length === 0 ? (
                        <div className="bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-200 dark:border-slate-800 p-10 text-center flex flex-col items-center justify-center">
                        ...
                        <>
                          ...
                          <div className="space-y-4 md:hidden">
                            {transportData.trains.map((train, index) => (
                              <div key={`train-mob-${train.id || index}`} className="group bg-white dark:bg-slate-950 p-5 rounded-2xl shadow-sm hover:shadow-md border border-slate-200 dark:border-slate-800 hover:border-indigo-300 dark:hover:border-indigo-700 transition-all duration-300 space-y-4 relative overflow-hidden">
                                ...
                                <div className="bg-slate-50 dark:bg-slate-900/50 rounded-xl p-3 grid grid-cols-2 gap-3 border border-slate-100 dark:border-slate-800/50">
                                  <div>
                                ...
                                <div className="flex justify-between items-center text-sm pt-2">
                                  ...
                                  <div className="flex items-center gap-1.5 text-slate-500 dark:text-slate-400 font-bold bg-slate-100 dark:bg-slate-800 px-3 py-1 rounded-lg text-xs">
                          ...
                          <div className="hidden md:block bg-white dark:bg-slate-950 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
                                ...
                                <tbody className="divide-y divide-slate-100 dark:divide-slate-800/50">
                                  {transportData.trains.map((train, index) => (
                                    <tr key={`train-desk-${train.id || index}`} className="group hover:bg-indigo-50/30 dark:hover:bg-indigo-900/10 transition-colors duration-200">
                                      ...
                                      <td className="px-6 py-5">
                                        <span className="inline-flex items-center justify-center min-w-[3rem] bg-slate-100 dark:bg-slate-800 text-xs px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-300 font-bold border border-slate-200 dark:border-slate-700 shadow-sm">
                                          {train.platform}
                                        </span>
                                      </td>
                                      <td className="px-6 py-5 text-right">
                                        <span className="inline-flex items-center gap-1.5 bg-slate-50 dark:bg-slate-900/50 text-xs px-3 py-1.5 rounded-xl font-semibold text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-800">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                          {transportData.buses.map((bus, index) => (
                            <div
                              ...
                              className="group relative border border-slate-200 dark:border-slate-800 rounded-3xl p-6 bg-white dark:bg-slate-950 flex flex-col gap-5 hover:shadow-xl hover:shadow-emerald-500/5 dark:hover:shadow-emerald-500/5 hover:border-emerald-300 dark:hover:border-emerald-700 transition-all duration-300 overflow-hidden"
                            >
                              ...
                              <div className="flex items-start gap-4 relative z-10">
                                ...
                                <div className="min-w-0 flex-grow pt-1">
                                  ...
                                  <div className="inline-flex items-center gap-1.5 text-slate-500 dark:text-slate-400 text-xs mt-2.5 font-bold bg-slate-100 dark:bg-slate-900 px-2.5 py-1 rounded-md">
                              ...
                              <div className="bg-slate-50 dark:bg-slate-900/50 rounded-2xl p-4 flex justify-between items-center text-sm font-semibold border border-slate-100 dark:border-slate-800/50 relative z-10">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                          {transportData.totos.map((toto, index) => (
                            <div
                              ...
                              className="group border border-slate-200 dark:border-slate-800 rounded-3xl p-6 text-center flex flex-col justify-between bg-white dark:bg-slate-950 hover:shadow-xl hover:shadow-amber-500/5 hover:border-amber-300 dark:hover:border-amber-700 transition-all duration-300 relative overflow-hidden h-full min-h-[200px]"
                            >
                              ...
                              <div className="relative z-10 flex flex-col h-full">
                                ...
                                <div className="pt-5 border-t border-slate-100 dark:border-slate-800/80">
                                  ...
                                  <span className="block text-[10px] text-slate-400 dark:text-slate-500 mt-2 font-black uppercase tracking-widest bg-slate-50 dark:bg-slate-900 py-1 px-3 rounded-full mx-auto w-fit">
                                    Standard Seat Fare
                                  </span>
                                </div>
                              </div>
