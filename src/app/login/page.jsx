  ...
  return (
    <div className="w-full flex justify-center py-12 lg:py-16 px-4 select-none relative z-10">
      ...
      <div className={`auth-container panel-${panelActive}-active relative w-full max-w-md h-[650px] flex justify-center`}>
            ...
            {authStep === "signin" && (
              <>
                ...
                <div className="text-center text-xs font-bold text-slate-700 dark:text-slate-400 mt-6">
                  ...
                  <button onClick={() => togglePanel('right')} className="text-primary-650 hover:underline cursor-pointer font-extrabold ml-1">
                    Create account
                  </button>
                </div>
            ...
            {authStep === "forgot" && (
              <>
                ...
                <form onSubmit={handleSendReset} className="space-y-6">
                  ...
                  <button 
                    type="submit" disabled={authLoading} 
                    className="w-full neumorphic-btn py-3.5 text-sm font-extrabold tracking-wide transition-all cursor-pointer"
                  >
        ...
        </div>        {/* Sign Up Container (Right Panel) */}
        <div id="signup-container" className="auth-panel">
          <div className="neumorphic-card p-8">
            ...
            <form onSubmit={handleSignUp} className="space-y-4">
              ...
              <button 
                type="submit" disabled={authLoading}
                className="w-full neumorphic-btn py-3.5 text-sm font-extrabold tracking-wide transition-all cursor-pointer disabled:opacity-50 mt-4"
              >
            ...
            <div className="text-center text-xs font-bold text-slate-700 dark:text-slate-400 mt-6">
              ...
              <button onClick={() => togglePanel('left')} className="text-primary-650 hover:underline cursor-pointer font-extrabold ml-1">
      ...
      {isAwaitingConfirmation && (
        <div className="fixed inset-0 z-50 bg-slate-950/60 backdrop-blur-sm flex items-center justify-center p-4 animate-zoom-in-fade">
          <div className="neumorphic-card p-8 max-w-md w-full text-center animate-bounce-in">
            ...
            <div className="p-4 neumorphic-inset mb-6 text-xs font-black text-slate-500">
